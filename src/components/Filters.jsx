...
function Filters() {
	...
	return (
		<div
			className={`filters fixed left-0 z-10 flex w-full justify-between space-x-4 border-y-2 border-black bg-[#FAF8ED] px-20 py-2 font-ptSansCaption text-xs font-normal sm:space-x-2 md:my-1 md:space-x-1 xl:my-[52px] transition-all duration-500 ease-in-out ${
