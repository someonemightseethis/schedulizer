function Filters() {
	return (
		<div className="fixed left-0 z-10 flex w-full justify-between space-x-4 border-b-2 border-black bg-[#FAF8ED] px-20 py-2 font-ptSansCaption text-sm font-normal opacity-95 xs:my-[66px] sm:my-[66px] sm:space-x-2 md:my-1 md:space-x-1 xl:my-3">
			<a
				href="#"
