		...
		<Layout>
			<div className="mb-24 flex flex-col pb-28 pt-52">
				<div className="heroText">
					...
					<h1 className="appointment py-4 text-center font-bebas text-6xl font-semibold text-indigo-500 sm:text-6xl md:text-8xl lg:text-[12rem] xl:text-[12rem]">
						Appointment Scheduling
					</h1>
					<h2 className="solution px-8 text-center font-bebas text-6xl font-medium sm:px-32 sm:text-right">
						Solutions
					</h2>
				</div>
			...
			<div className="mx-auto max-w-screen-xl px-8 py-20">
				...
				<div className="text-md px-32 font-muktaVaani">
					<p>
						...
						transcends the capabilities of existing solutions. This endeavor is
						fueled by the desire to streamline and elevate the scheduling
						...
						process. Additionally, we are pioneering innovative functionalities
						such as group scheduling, meeting customization, payment
						integration, analytics, and AI-powered scheduling assistance. These
						features are carefully designed to address the specific challenges
						faced by local businesses, offering seamless solutions for their
						diverse scheduling needs. Our ultimate goal is to provide a
						comprehensive and user- friendly scheduling tool that enhances the
						operational efficiency of clinics, salons, and small businesses,
