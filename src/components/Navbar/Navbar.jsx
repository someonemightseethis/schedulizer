...
function Navbar() {
	return (
		<div className="fixed px-6 left-0 w-full bg-[#FAF8ED] z-10 border-b-2 border-black opacity-[0.98]">
			<nav className="px-4 py-2 flex justify-between items-center space-x-2 lg:space-x-4">
				<div className="flex-shrink-0 flex items-center">
					...
					<Link to="/schedulizer/">
						<span className="text-black text-4xl font-medium font-bebas">Schedulizer</span>
					</Link>
				</div>
				<Searchbar />
				<NavbarLinks />
				...
				<div className="flex justify-between space-x-16">
					<div className="flex items-center space-x-8">
						<a className="flex items-center" href="#">
							<svg
								...
								height="1.25em"
								viewBox="0 0 448 512"
								className="animate-wiggle animate-infinite animate-duration-[600ms] hover:animate-duration-[200ms]"
							>
					...
					>
						...
						<p className="px-4 text-sm text-black group-hover:underline group-hover:underline-offset-4 font-ptSansCaption">
							username
						</p>
					</Link>
				</div>
