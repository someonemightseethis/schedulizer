		...
		<div className="fixed top-0 left-0 z-10 w-full bg-[#FAF8ED] px-6 drop-shadow-md">
			<nav className="flex items-center justify-between space-x-2 px-4 py-1 lg:space-x-4">
				<div className="flex flex-shrink-0 items-center">
					...
					<Link to="/schedulizer/">
						<span className="font-bebas text-4xl font-medium text-black">
							Schedulizer
						</span>
					</Link>
				</div>
				...
				<div className="flex justify-between space-x-16">
					...
					<Link
						...
						<p className="px-4 font-ptSansCaption text-sm text-black group-hover:underline group-hover:underline-offset-4">
