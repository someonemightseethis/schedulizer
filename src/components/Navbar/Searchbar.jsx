		...
		<div className="flex w-full max-w-lg items-center xs:hidden sm:hidden lg:block lg:max-w-xs xl:block">
			<form method="get" action="#" className="flex items-center">
				<input
					...
					className="placeholder:text-grey-700 mb-2 mr-2 mt-2 flex w-full items-center rounded-lg border-2 border-indigo-500 px-3 py-2 font-muktaVaani text-xs text-black focus:border-indigo-600 focus:outline-none"
				/>
				<button
					type="submit"
					id="searchsubmit"
