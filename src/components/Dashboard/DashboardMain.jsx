...
function DashboardMain() {
	return (
		<div className="bg-[#FAF8ED] py-12 md:ml-[226px] xl:lg:ml-[208px]">
			<h2 className="justify-left mb-12 flex items-baseline font-bebas text-9xl font-semibold md:px-24 xl:lg:px-24">
				Good day,
				<p className="font-ptSansCaption text-4xl font-medium">
					&ensp; username
				</p>
			</h2>
			<div className="flex items-center justify-center pb-12 xs:flex-col xs:gap-y-12 sm:flex-col sm:gap-y-12 md:flex-col md:gap-y-16 md:space-x-12 md:px-24 xl:lg:flex-row xl:lg:px-24 xl:lg:space-x-56">
