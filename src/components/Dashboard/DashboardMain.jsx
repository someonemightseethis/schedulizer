...
function DashboardMain() {
	return (
		<div className="bg-[#FAF8ED] py-12 pattern-texture-indigo-500/30 pattern-texture-scale-[1.5] md:ml-[226px] md:px-24 xl:lg:ml-[208px] xl:lg:px-20">
			...
			<div className="flex items-center justify-between xs:flex-col xs:gap-y-12 sm:flex-col sm:gap-y-12 md:flex-col md:gap-y-16 md:space-x-12 md:px-12 xl:lg:flex-row xl:lg:px-48 xl:lg:space-x-12">
				<div className="rounded-lg border-2 border-black bg-[#FAF8ED] px-12 py-6">
