...
function MemberCard({ member }) {
	return (
		<div className="rounded-xl bg-[#FAF8ED] p-8 shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] transition-all duration-500 hover:scale-[1.02] lg:mb-0">
			<img
