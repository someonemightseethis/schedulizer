...
function MemberCard({ member }) {
	return (
		<div className="rounded-xl bg-[#FAF8ED] p-8 shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] transition-all duration-500 hover:scale-[1.02] lg:mb-0 border-indigo-200 border-2">
			<img
				className="mx-auto mb-6 h-16 border-[#2B3467]"
				src={member.profileImageSrc}
				alt="avatar"
			/>
			<h5 className="mb-4 font-poppins font-semibold">{member.name}</h5>
			<p className="mb-6 font-muktaVaani text-sm font-light">
				{member.designation}
			</p>
			<ul className="mx-auto flex list-inside justify-center space-x-2">
				<a href={member.socialLinks.twitter} className="px-2">
					<svg
						...
						height="1em"
						viewBox="0 0 512 512"
						className="fill-indigo-500 duration-200 ease-in-out hover:scale-110 hover:fill-indigo-600">
