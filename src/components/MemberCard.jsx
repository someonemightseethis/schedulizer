...
function MemberCard({ member }) {
  return (
    <div className="my-12 lg:mb-0 p-2">
      <img
        className="mx-auto mb-6 w-[100px] border-[#2B3467] hover:scale-105"
      ...
      <ul className="mx-auto flex list-inside justify-center space-x-2">
        <a href={member.socialLinks.twitter} className="px-2">
          <svg
            ...
            height="1em"
            viewBox="0 0 512 512"
            className="fill-indigo-500 hover:fill-indigo-600 hover:scale-125"
          >
